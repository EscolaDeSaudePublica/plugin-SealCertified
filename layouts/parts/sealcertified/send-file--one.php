...
<img class="js-sealcertifiedone-img" src="<?= $file_one->url ?>"  style="width: 200px !important;
...
<input name="name_sealcertifiedone" id="name_sealcertifiedone" type="text" class="signature-input" placeholder="Escreva o nome aqui" size="60" value="<?= $entity->name_sealcertifiedone ?? "" ?>" />
<hr>